...
CREATE TABLE FITNESSGOALS (
    ...
    GOAL_TYPE_ID INT REFERENCES GOAL_TYPE ON DELETE SET NULL, -- Type of goal (e.g., weight loss, muscle gain, endurance)
    TARGET_VALUE DECIMAL, 
    START_DATE DATE NOT NULL,
    END_DATE DATE,
    ACHIEVED BOOLEAN DEFAULT FALSE -- Indicates if the goal has been achieved
);
